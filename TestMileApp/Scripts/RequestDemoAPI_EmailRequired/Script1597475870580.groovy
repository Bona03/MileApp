...
String RequestBody = '{ "full_name":"Bona","email":"","phone":"08227365200","organization_name":"pt.jaya"}'
...
WS.verifyElementPropertyValue(postDemo, 'message', 'The email field is required.')
