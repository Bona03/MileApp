...
String RequestBody = '{ "full_name":"Bona","email":"bona@gmail.com","phone":"abc","organization_name":"pt jaya"}'
...
WS.verifyElementPropertyValue(postDemo, 'message', 'The phone field may only contain numeric characters.')
